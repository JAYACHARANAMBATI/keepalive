...
export default function Home() {
  ...
  const structuredData = {
    ...
    description:
      "KeepAlive automatically pings your Render/Railway free-tier server every 10 minutes so it never cold-starts. No login. No credit card. Free forever.",
    creator: {
      "@type": "Person",
      name: "Jaya Charan Ambati",
      url: "https://www.linkedin.com/in/jaya-charan-ambati-901052254/",
    },
    aggregateRating: {
          ...
          <div className="max-w-3xl mx-auto w-full">
            ...
            <div className="mb-16">
              ...
              <p className="text-gray-500 text-base leading-relaxed max-w-xl">
                This isn&apos;t a resume project. It came from a single,
                specific, painful moment that I never want another developer to
                experience.
              </p>
            </div>
            ...
            <div className="space-y-0">
              ...
              <div className="relative flex gap-6 pb-12">
                ...
                <div className="flex-1 pt-1.5 pb-2">
                  ...
                  <p className="text-gray-500 text-sm leading-[1.9]">
                    I built an AI-powered web app in college — not a tutorial,
                    not a copy-paste. Something I designed from scratch, rewrote
                    four times, stayed up past 2am for. When I finally deployed
                    it to Render&apos;s free tier and saw my URL live on the
                    internet, I remember staring at the screen for a full
                    minute.{" "}
              ...
              <div className="relative flex gap-6 pb-12">
                ...
                <div className="flex-1 pt-1.5 pb-2">
                  ...
                  <p className="text-gray-500 text-sm leading-[1.9] mb-5">
                    My professor stood right behind me. The class was gathered.
                    I opened the app with complete confidence — I knew every
                    line of code. I clicked the main button. And the screen
                    just... sat there. A spinner. Five seconds. Ten. Twenty.{" "}
                    <strong className="text-gray-800 font-semibold">
                      Thirty-one seconds of absolute silence
                    </strong>{" "}
                    while everyone watched. People shifted. Someone whispered.
                    My professor exhaled and moved on to the next student.
                  </p>
                  ...
                  <p className="text-gray-900 text-sm font-semibold mt-5 pl-4 border-l-4 border-red-400 py-2">
                    Three weeks of work. Judged in one moment. Not by my code.
                    By a server that decided to nap.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex gap-6 pb-12">
                ...
                <div className="flex-1 pt-1.5 pb-2">
                  ...
                  <p className="text-gray-500 text-sm leading-[1.9]">
                    Not a bug. A policy. Designed to make free users feel the
                    pain until they upgrade. No setting to disable it. No
                    workaround offered. Just:{" "}
                ...
                <div className="flex-1 pt-1.5">
                  ...
                  <div className="bg-gray-900 rounded-2xl px-6 py-5 flex items-start gap-4">
                    ...
                    <p className="text-sm text-gray-300 leading-relaxed">
                      ...
                      Not a 30-second spinner. Not a professor&apos;s sigh. Not
                      a recruiter closing the tab. The first thing anyone sees
                      when they open your project should be your project —
                      instant, sharp, ready. KeepAlive makes sure of that.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-5xl mx-auto w-full">
            ...
            <div className="mb-10 sm:mb-16">
              ...
              <p className="text-gray-400 text-sm sm:text-base max-w-xl leading-relaxed">
                ...
                warning. No setting to turn it off. The next person to visit
                just waits — and usually leaves.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div className="bg-white border border-gray-100 rounded-2xl p-7 shadow-sm hover:shadow-md transition-shadow duration-200">
                ...
                <p className="text-gray-900 font-bold text-lg leading-snug mb-3">
                  &ldquo;I built an AI project for 3 weeks. Demo day, my
                  professor stood right behind me. I clicked the button. Nothing
                  loaded for 31 seconds.&rdquo;
                </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              ...
              <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  ...
                  between two other candidates. A 30-second spinner looked
                  exactly like a broken project. You never heard back.
                </p>
              </div>
              ...
              <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  ...
                  start kills it before it starts. The model isn&apos;t slow —
                  the server just hadn&apos;t woken up yet.
                </p>
              </div>
              ...
              <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  ...
                  experiences a broken first load doesn&apos;t give second
                  chances — especially if they found you through word of mouth.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-900 rounded-2xl px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-5">
              <div>
                ...
                <p className="text-gray-400 text-sm mt-1">
                  The server just fell asleep. KeepAlive keeps it awake —
                  quietly, automatically, at no cost.
                </p>
              </div>
              <a
                href="#add"
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-500 text-lg max-w-2xl mx-auto">
                ...
                environments, staging servers, internal tools, microservices —
                all sitting idle, all costing money, all going to sleep.
                KeepAlive fixes all of them. For free.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  detail:
                    "5 devs × 1 backend each = 5 URLs protected. Cost: ₹0.",
                        ...
                        !message.toLowerCase().includes("already") && (
                          <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 mt-1">
                            <p className="text-xs font-bold text-gray-700 mb-2.5 flex items-center gap-1.5">
                              ...
                              Still not working? Ping me directly — I&apos;ll
                              fix it for you.
                            </p>
                            ...
                            <p className="text-xs text-gray-400 mt-2.5 leading-relaxed">
                              Send me your URL and what happened. I&apos;ll add
                              it manually and get back to you within a few
                              hours. No worries at all.
                            </p>
                          </div>
                        )}
                    </div>
        ...
        <footer className="bg-white border-t border-gray-100 py-14 px-6">
          <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-start justify-between gap-10">
            ...
            <div className="max-w-xs">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Built by a student who got tired of cold starts during demos.
                Made for every developer who deserves better.
              </p>
          ...
          <div className="max-w-5xl mx-auto mt-10 pt-6 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-3">
            <p className="text-xs text-gray-400">
              © {new Date().getFullYear()} KeepAlive. Open source · Free
              Forever.
            </p>
